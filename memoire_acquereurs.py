...
CONSIGNE_MATCH = (
    ...
    "ne correspond.\n\n"
    "Sois honnete et severe : un score eleve doit etre merite. Si le type de "
    "bien ne correspond pas, le score est bas quoi qu'il arrive.\n\n"
    "REGLE DU BUDGET, a respecter absolument :\n"
    "Un budget est un PLAFOND, jamais une cible ni une fourchette a respecter. "
    "Un bien MOINS CHER que le budget est un AVANTAGE, jamais un defaut. Ne "
    "baisse JAMAIS le score parce qu'un bien est en dessous du budget, et "
    "n'ecris jamais qu'un prix est trop bas : un acquereur qui trouve ce qu'il "
    "cherchait pour moins cher est un acquereur ravi, et la marge lui sert a "
    "faire des travaux ou a l'emporter face a un autre acheteur. Quand deux "
    "chiffres sont cites, par exemple 1,8 et 1,9 million, le plus eleve est le "
    "plafond et le plus bas n'est qu'une intention, pas un minimum. Tu ne "
    "penalises que le DEPASSEMENT du plafond.\n\n"
